...
protected:
    ...
    void print_block(shared_ptr<Node> bl, ofstream &f);
    void print_oper_list(shared_ptr<Node> lst, ofstream &f);
    void print_oper(shared_ptr<Node> bl, ofstream &f);
    void print_eq(shared_ptr<Node> bl, ofstream &f);
    void print_ext(shared_ptr<Node> bl, ofstream &f);
    void print_logic(shared_ptr<Node> bl, ofstream &f);
    void print_doubl(shared_ptr<Node> bl, ofstream &f);
};
